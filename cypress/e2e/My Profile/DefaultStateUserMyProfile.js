...
describe("Verify My Profile for default state user", function () {
    beforeEach(() => {
    ...
    it("Verify test state users are able to view my profile user information", function () {
        ...
        viewMyProfile.elements.myProfileFirstLastName().should('have.text', 'cypress default');
        viewMyProfile.elements.username().should('have.text', 'cypress.default')
        viewMyProfile.elements.email().should('have.text', 'tyler.smith+cypressdefault@icf.com')
        ...
        viewMyProfile.clickOnRequestStateManagerAccessForStateUser();
        viewMyProfile.elements.requestStateAuthorizedOfficialAccessModalText().should('have.text', 'Request State Manager Access')
        ...
        viewMyProfile.clickOnRequestStateAuthorizedOfficialAccessBtnForStateUser();
    ...
    it("Verify test state users are able to view my profile from welcome username", function () {
        cy.visit('/User');
        commonPage.verifyUrl('/User');
    ...
    it("Verify default state user is able to edit firstname,lastname and phone number for my profile", function () {
        cy.visit('/User');
        commonPage.verifyUrl('/User');
        commonPage.clickOnWelcomeBtn();
        commonPage.verifyUrl('/User/Profile');
        ...
        editMyProfile.elements.lastNameTextBox().should('have.value', 'default')
        ...
        editMyProfile.elements.userEmailTextBox().should('have.value', 'tyler.smith+cypressdefault@icf.com');
        ...
        editMyProfile.elements.stateUserForTestStateStateText().should('contain', 'State User for Test State');
        editMyProfile.elements.secondaryRoleTextForState().should('have.text', 'Secondary Role');
        ...
        editMyProfile.elements.currentUserInfoLastName().should('have.text', 'default');
        editMyProfile.elements.currentUserInfoUsername().should('have.text', 'cypress.default');
        editMyProfile.elements.currentUserInfoUserEmail().should('have.text', 'tyler.smith+cypressdefault@icf.com');
        ...
        editMyProfile.elements.oldInformationLName().should('have.text', 'default')
    ...
    it("Change user information back to original user information", function () {
        ...
        commonPage.verifyBreadCrumbs('My Profile', 'Edit My Profile');
        commonPage.elements.headerH3Text().should('have.text', 'Edit My Profile');
        editMyProfile.enterDefaultUsernamePasswordAndPhone('cypress', 'default', '5082460311');
        editMyProfile.clickOnPreviewEdits();
        editMyProfile.elements.revisedInformationText().should('have.text', 'Revised Information');
        editMyProfile.elements.revisedInformationFName().should('have.text', 'cypress')
        editMyProfile.elements.revisedInformationLName().should('have.text', "default")
