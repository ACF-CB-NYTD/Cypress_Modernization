...
describe("State User Transmission Page", function () {
    ...
    it("Verify Transmission Summary page details", function () {
        ...
        transmissionsSummaryObjects.elements.transmissionSubmitBtn().should('not.exist', 'Submit Transmission');
        transmissionsSummaryObjects.elements.transmissionDeleteBtn().should('not.exist', 'Delete Transmission');
    });
