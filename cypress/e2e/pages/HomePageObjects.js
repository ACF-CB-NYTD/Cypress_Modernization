class HomePageObjects {
    elements = {
        ...
        nytdHelpDeskDaysOfOperationText: () => cy.get('.styles_hoursOfOperationText__JQbuy > :nth-child(1)'), // Hours of operation text.
        nytdHelpDeskHoursOfOperationText: () => cy.get('.styles_hoursOfOperationText__JQbuy > :nth-child(2)'), // Hours of operation text.
        ...
        eyeIcon: () => cy.get('.nytd-icon-button > .usa-icon > path'), // Eye icon to hide the password
