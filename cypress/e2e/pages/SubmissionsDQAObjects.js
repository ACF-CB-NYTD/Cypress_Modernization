...
class SubmissionsDQAObjects {
    elements = {
        ...
        lastRecordLink: () => cy.get(':nth-child(1) > :nth-child(1) > .styles_viewButton__bYvRo'),
        ...
        sixRecordLink: () => cy.get(':nth-child(6) > :nth-child(1) > .styles_viewButton__bYvRo'),
    }
...
export default SubmissionsDQAObjects;